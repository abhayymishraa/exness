// Vendored from Magic UI (MIT) - https://magicui.design/docs/components/number-ticker
// Source: https://magicui.design/r/number-ticker.json (registry copy, imports adapted for Vite)
"use client"
