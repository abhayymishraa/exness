// Vendored from Magic UI (MIT) - https://magicui.design/docs/components/lens
// Registry copy, imports adapted for Vite.
"use client"
...
export function Lens({
  ...
  return (
    <div
      ref={containerRef}
      className="relative z-20 overflow-hidden rounded-[3px]" /* radius matched to this project; the registry hardcodes rounded-xl */
